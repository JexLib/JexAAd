...
import com.jex.aad.base.BasePresenter;
import com.jex.aad.support.listview.ILoadMoreListener;
...
public abstract class ABSLoadMorePresenter<V extends ILoadMoreView, M extends ILoadMoreModel> extends BasePresenter<V, M>
     ...
     * 初始化Model层的数据请求参数
     * <p>
     * {@link com.jex.aad.support.recyclerview.loadmore.ILoadMoreModel#loadData(Map, int)}
     *
